<template>
    <div>
        <div class="card-header mb-3">
            <h4 v-if="tipoID!==undefined">Edição de Tipo</h4>
            <h4 v-else>Cadastro de Tipo</h4>
        </div>
        <b-form>
        <b-form-group label="Tipo:" :state="nomeOK"  invalid-feedback="Nome Esperado">
            <b-input-group>
                <b-form-input :state="nomeOK" 
                    type="text" placeholder="Tipo" v-model="obj.nome" trim >
                </b-form-input>
            </b-input-group>
        </b-form-group>
