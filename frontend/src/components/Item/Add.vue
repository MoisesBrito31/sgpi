<template>
    <div>
        ...
        <b-form-group class="mt-3 pt-3">
            <b-button @click="Put(true)" v-bind:class="{disabled:!podeCadastrar}"  block variant="primary">
                <span v-show="espera">
             ...
             <b-button @click="Put(false)" v-bind:class="{disabled:!podeCadastrar}"  block variant="primary">
                <span v-show="espera">
                <b-spinner type="grow" variant="light"></b-spinner>
                <b-spinner type="grow" variant="light"></b-spinner>
                <b-spinner type="grow" variant="light"></b-spinner>
...
<script>
import FabriAdd from './fabricante/Add-Edit'
